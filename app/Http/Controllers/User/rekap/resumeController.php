...
class resumeController extends Controller
{
    ...
    {
        $show = resume::orderBy('updated_at','desc')->get();
        ...
        return view('pages.daily.resume')->with('list', $data);
    }
    ...
    public function table()
    {
        ...
        $data = DB::table('resume')
                ->join('customer', 'customer.id', '=', 'resume.id_customer')
                ->select('resume.*','customer.nama')
                ->where('resume.deleted_at', null)
